...
Thank you for using GitHub Search Downloader! Here is how to get help and find answers to your questions:

## 1. Documentation & Guides
- **Architecture & Design:** Check [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).
- **Architecture Decisions:** Read our [docs/decisions/](docs/decisions/) records.
